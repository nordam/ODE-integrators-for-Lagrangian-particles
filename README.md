...
* Note also that the executables expect to find input data in `../data/`, and expect to be able to write their output to `../results/`. Adjust paths, or edit the code in `src/parameters.f90` as required.
